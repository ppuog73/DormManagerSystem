...
<%@taglib prefix="wdlPager" uri="wdl-page-tag"%><%--引入自定义分页标签--%>
...
<div class="data_list">
    ...
    <form name="myForm" class="form-search" method="post" action="student.action?action=list" style="padding-bottom: 0px">
        <button class="btn btn-success" type="button" style="margin-right: 50px;" onclick="window.location='student.action?action=preAdd'">添加</button>
        ...
        <table class="table table-striped table-bordered table-hover datatable">
            ...
            <c:forEach items="${students}" var="student">
                <tr>
                    ...
                    <td>${student.tel}</td>
                    <td>
                        <button class="btn btn-mini btn-info" type="button" onclick="window.location='student.action?action=preUpdate&id=${student.id}'">修改</button>&nbsp;

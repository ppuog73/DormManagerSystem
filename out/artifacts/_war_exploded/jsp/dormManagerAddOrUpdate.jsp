...
<script type="text/javascript">
    function checkForm(){
        ...
        //获取所有的宿舍楼复选框
        let dormBuildIdCheckBox = document.getElementsByName("dormBuildId");
    ...
    window.onload = function(){
        //获取所有的复选框
        let dormBuildIdInputs = document.getElementsByName("dormBuildId");

        //获取当前宿舍管理员管理的楼栋ID  通过"${userBuildids}"获取得到的是一个String类型的数据
        let userBuildids = JSON.parse("${userBuildids}");

        for (let i = 0; i < dormBuildIdInputs.length; i++) {
        ...
        <div class="data_form" >
            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="tel" id="tel" value="${user.tel}" style="margin-top: 5px;height: 30px;"></td>
                </tr>
                <tr>
